            ...
            <div className="flex items-center gap-3.5 w-full sm:w-auto text-center sm:text-left rtl:sm:text-right">
              ...
              <div className="space-y-0.5">
                <div className="flex flex-wrap items-center gap-2">
                  <h3 className={`text-sm md:text-base font-black transition-colors duration-300 ${
                ...
                <p className={`text-[11px] md:text-xs transition-colors duration-300 leading-normal ${
