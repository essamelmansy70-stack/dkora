...
export const translations: Record<'ar' | 'en', TranslationType> = {
  ar: {
    ...
    legal: {
      ...
      aboutBtn: "من نحن",
      aboutHeaderBadge: "منصة dkora لمعالجة وضغط الصور رقمياً",
      ...
      privacyDesc1: "لا يطلب تطبيق dkora ولا يجمع أو يخزن أي بيانات تعريفية شخصية للمستخدمين، أو عناوين بريد، أو أرقام تواصل. الخدمة مخصصة كلياً للاستفادة التقنية المباشرة بدون تسجيل مسبق.",
      ...
      termsHeaderBadgeDesc: "يرخص لك استخدام كافة الصور المحسنة والمحولة والصادرة عبر تطبيق dkora في كافة المشاريع الشخصية والتجارية، كالمتاجر والمواقع والمدونات، دون أي مسائلة أو شروط مادية أو قيود مالية.",
      termsLabel1: "1. شروط وقواعد الاستخدام:",
      termsDesc1: "باستخدامك لمنصة dkora وتعديل صورك عليها، فإنك تقر وتوافق صراحة على كافة البنود وبنود العمل المذكورة هنا دون أي تحفظ قانوني طوعاً.",
  ...
  en: {
    ...
    legal: {
      ...
      aboutBtn: "About Us",
      aboutHeaderBadge: "About dkora Local Smart Engine",
      ...
      privacyDesc1: "dkora does not request, solicit, collect, or store any personal data, analytical profiles, addresses, or user tracking cookies. We are entirely cookie-free for native features.",
      ...
      termsHeaderBadgeDesc: "You are granted a perpetual, worldwide, non-exclusive license to use any asset generated or processed with dkora for both personal and commercial distribution (YouTube, online shops, Facebook Ads, newsletters) with zero fees.",
      termsLabel1: "1. Acceptance of Terms:",
      termsDesc1: "By utilizing the dkora platform, you willingly consent to our operational conditions and usage rules described in this document.",
