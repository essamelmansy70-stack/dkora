...
2. مباشرة من **بطارية السيارة 12V** باستخدام المشابك المرفقة.`,
  ...
  },
  {
    ...
    isBestValue: true,
    pros: [
      "بطارية ليثيوم 12V قابلة للشحن بواسطة كابل USB Type-C لسهولة الشحن في أي مكان",
      "عزم دوران 20 نيوتن متر مع 15+1 وضع للقابض للتحكم الدقيق في ربط البراغي",
      "كشاف إضاءة LED مدمج لإضاءة أماكن العمل المظلمة والدقيقة",
      "مؤشر ضوئي لمستوى شحن البطارية لمتابعة الطاقة المتبقية",
      "تصميم مدمج ومقبض مطاطي مريح للغاية للعمل لفترات طويلة"
    ],
    cons: [
      "مخصص للأعمال المتوسطة والربط والحفر في الخشب والصاج؛ للمهام الخرسانية الثقيلة جداً يُفضل شنيور 20V أو هيلتي"
    ],
    targetAudience: "أصحاب المنازل وفنيو الصيانة والديكور اليدوية الراغبون في شراء شنيور انكو لاسلكي خفيف وعملي يسهل شحنه بكابل الموبايل وبسعر اقتصادي ممتاز 800 ج.م.",
...
أداة تثبيت المسامير المعدنية المحمولة هي الحل الذكي والعملي لكل من يرغب في تعليق الأدوات أو تثبيت القطع المختلفة على الحائط دون الحاجة إلى معدات كهربائية أو أدوات معقدة. تأتي هذه الأداة بتصميم مريح وسهل الاستخدام، مما يجعلها مناسبة للاستخدام المنزلي والمهني على حد سواء.`,
    specs: [
      { label: "نوع الأداة والاسم", value: "مسدس مسامير يدويه (أداة تثبيت المسامير المحمولة)" },
      { label: "الأبعاد والوزن", value: "الطول 35 سم × العرض 6 سم | وزن خفيف مدمج" },
      { label: "الأسطح المتوافقة", value: "الطوب، الخرسانة، الإسمنت، والألواح الصلبة" },
      { label: "الملحقات المرفقة", value: "10 مسامير صلب مجانية جاهزة للاستخدام" },
      { label: "السعر ورابط الشراء", value: "850 ج.م على متجر أمازون مصر (https://link.amazon/B04siMqb4)" }
    ],
    viewsCount: 16500,
    dateAdded: "2026-03-30",
    tags: ["مسدس مسامير يدويه", "أداة تثبيت المسامير", "مسدس مسامير خرسانة", "أدوات صيانة منزلية", "أمازون"]
  },
  {
    id: "p-apt-airless-paint-sprayer-1200w-dw3912",
    titleAr: "ايه بي تي جهاز رش دهانات كهربائي بدون هواء (Airless Paint Sprayer) بقدرة 1200 واط وتدفق 1.6L/min",
    titleEn: "APT 1200W Airless Paint Sprayer Machine 1.6L/min (DW3912)",
    slug: "apt-airless-paint-sprayer-1200w-dw3912",
    categoryId: "cat-electric-tools",
    brandId: "b-apt",
    brandName: "ايه بي تي - APT",
    modelNumber: "DW3912 | ASIN: B082M3Z49L",
    mainImage: "https://i.postimg.cc/k47Lpvgk/61e2o4Y9a1L.jpg",
    gallery: [
      "https://i.postimg.cc/k47Lpvgk/61e2o4Y9a1L.jpg"
    ],
    rating: 4.5,
    reviewCount: 92,
    editorScore: 9.3,
    ...
    summary: "أفضل جهاز رش دهانات كهربائي بدون هواء (Airless) من ايه بي تي بقدرة 1200 واط ومعدل تدفق 1.6 لتر/دقيقة بسعر 2,450 ج.م، خيارك الأول لطلاء الحوائط والأسقف بسرعة وانسيابية عالية.",
    fullReviewText: `إذا كنت تبحث عن **جهاز رش دهانات كهربائي بدون هواء** (Airless) يوفر لك أقصى سرعة وتغطية احترافية خالية من الآثار والجرات لطلاء الجدران، الأسقف، والأبواب، فإن جهاز ايه بي تي (APT) DW3912 بقدرة 1200 واط هو أحد أفضل الحلول القوية المتاحة لعام 2026.`,
    specs: [
      { label: "العلامة التجارية والموديل", value: "ايه بي تي (APT) | DW3912" },
      { label: "القوة والتدفق", value: "1200 واط | 1.6 لتر/دقيقة" },
      { label: "نوع الرش", value: "بدون هواء (Airless Paint Sprayer)" },
      { label: "السعر", value: "2,450 ج.م على أمازون مصر" }
    ],
    viewsCount: 8900,
    dateAdded: "2026-04-02",
    tags: ["جهاز رش دهانات", "ماكينة طلاء", "APT", "Airless", "دهان الحوائط", "أمازون"]
  },
  {
    id: "p-total-pipe-wrench-10inch-tht171006",
    titleAr: "توتال مفتاح أنبوبي ومفتاح انجليزي صغير 10 بوصة THT171006 - أفضل مفتاح سباكة للمواسير",
    titleEn: "TOTAL Pipe Wrench 10 Inch THT171006 Small Pipe Wrench",
    slug: "total-pipe-wrench-10inch-tht171006",
    categoryId: "cat-hand-tools",
    brandId: "b-total",
    brandName: "توتال - TOTAL",
    modelNumber: "THT171006 | ASIN: B083R9YFVP",
    ...
    isBestValue: true,
    pros: [
      "جسم مصنوع من حديد الزهر اللين عالي التحمل المقاوم للكسر والانثناء تحت عزم الدوران الشديد",
      "فك متحرك وسفلية متينة من الفولاذ الكربوني المقوى بأسنان حادة تمسك المواسير بقوة ومنع الانزلاق",
      "مقاس مدمج 10 بوصات (250 ملم) ووزن 600 جرام يسهل العمل به في أماكن السباكة الضيقة وتحت الأحواض",
      "مقبض بلاستيكي مطاطي بعزل متين باللونين الأخضر والرمادي يمنع انزلاق اليد عند وجود زيوت أو مياه",
      "سعر اقتصادي ممتاز (220 ج.م) بخصم 31% على أمازون مصر مع تقييم ممتاز 4.4 من 5 نجوم"
    ],
    cons: [
      "أقصى قطر فتحة للفك هو 34 ملم؛ للمواسير الضخمة جداً (أكثر من 1.5 بوصة) يلزم شراء مقاس 12 أو 14 بوصة"
    ],
    targetAudience: "السباكون والصنايعية وأصحاب المنازل الراغبون في شراء مفتاح انجليزي صغير ومتين بخصم 31%.",
    summary: "إذا كنت تبحث عن أفضل مفتاح انجليزي صغير للسباكة والمواسير يضمن لك إحكام القبضة على الأنابيب المستعصية دون إتلافها، فإن مفتاح الأنابيب 10 بوصة من توتال THT171006 هو الاختيار المثالي لعام 2026 بسعر 220 ج.م على أمازون مصر.",
    fullReviewText: `إذا كنت تبحث عن **مفتاح انجليزي صغير** للسباكة والمواسير يضمن لك إحكام القبضة على الأنابيب المستعصية، فإن مفتاح الأنابيب 10 بوصة من توتال THT171006 هو الاختيار المثالي.`,
    specs: [
...
تأتي المجموعة كاملة بملحقات ذكية لتغطية جميع زوايا الحائط والحواف الضيقة والأركان الحادة، بالإضافة إلى مقبض قابل للربط بعصا التمديد للوصول للأماكن المرتفعة والأسقف بسهولة متناهية.`,
  ...
  },
  {
    ...
    specs: [
      ...
      { label: "العلامة التجارية والموديل", value: "انجكو INGCO | الموديل CSGLI20042" },
      { label: "البطارية الشاحن والوزن", value: "بطارية ليثيوم 20V (2.0Ah) + شاحن | الوزن 2.27 كجم" },
      { label: "سعة الخزان والتدفق", value: "1000 ملليلتر | معدل تدفق 0-800 مل/دقيقة" },
      { label: "اللزوجة والفوهات", value: "حتى 120 Din-s | 3 فوهات (1.5مم / 2.0مم / 2.5مم)" },
      { label: "السعر ورابط أمازون", value: "2,550 ج.م على متجر أمازون مصر (https://link.amazon/B0guAF2Kz)" }
    ],
    viewsCount: 14200,
    dateAdded: "2026-03-29",
